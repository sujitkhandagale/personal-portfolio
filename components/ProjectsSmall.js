        ...
        <section className='Home_projects'>
            ...
            <div className="container">
                <div className="Projects_boxes">
                    ...
                    <ProjectBox Project_image={Project2} Project_Title={"Bus Booking Template"} Project_description={"Bus Booking Website is Made on Reactjs with React Router Dom V6, And Scss ..."} />
